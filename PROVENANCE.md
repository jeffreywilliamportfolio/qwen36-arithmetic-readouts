...
- **History consolidation** (2026-09-14): after the initial publication, the GitHub history was consolidated into a single root commit. The v1.0.0 and v1.0.1 tags were removed, and v1.0.2 was repointed to the consolidated commit. This consolidation did not change the published file contents. Earlier commits remained resolvable by their full hashes when checked on September 15, 2026, and the historical audit manifests are preserved in `provenance/history/v1.0.1/`.
